...
// open a confirm modal when clicking on a delete btn / link
for (const openDelete of deleteBtn) {
  openDelete.addEventListener("click", (mouseEvent) =>
...
// form to create equipment and article
